            ...
            <div>
              {submitted ? (
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center gap-2 rounded-full bg-pink-600 px-6 py-3.5 font-semibold text-white shadow-sm shadow-pink/30 transition-all duration-200 hover:-translate-y-0.5 hover:bg-rust"
                  >
                    {t.newsletter.submit}
